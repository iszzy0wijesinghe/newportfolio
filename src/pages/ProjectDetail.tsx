...
import { projectDetailsById } from "../content/projects";
...
export default function ProjectDetail() {
  ...
  return (
    <div className="space-y-8">
      <Reveal>
        <div className="rounded-2xl border border-[rgb(var(--border))] bg-[rgb(var(--card))] p-5 shadow-soft">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
              <h1 className="text-2xl font-semibold tracking-tight">{project.title}</h1>
              <p className="mt-2 text-sm text-[rgb(var(--muted))]">{project.category}</p>
            </div>
            ...
            <div className="flex flex-wrap gap-2 sm:justify-end">
              {project.githubRepo?.trim() ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="px-3 py-2 rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--bg))] hover:bg-[rgb(var(--card))] transition text-sm font-semibold"
                >
                  GitHub
                </a>
              ) : null}
              ...
              {project.liveDemo?.trim() ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="px-3 py-2 rounded-xl bg-[rgb(var(--fg))] text-[rgb(var(--bg))] hover:opacity-90 transition text-sm font-semibold"
                >
                  Live Demo
                </a>
              ) : null}
      ...
      {project.problem?.trim() ? (
        <Reveal>
          <div className="rounded-2xl border border-[rgb(var(--border))] bg-[rgb(var(--bg))] p-5">
            ...
            <p className="mt-2 text-sm leading-6 text-[rgb(var(--muted))] whitespace-pre-line">
              {project.problem}
            </p>
          </div>
        </Reveal>
      ...
      {project.highlights?.length ? (
        <Reveal>
          <div className="rounded-2xl border border-[rgb(var(--border))] bg-[rgb(var(--bg))] p-5">
            ...
            <ul className="mt-3 grid gap-2 text-sm text-[rgb(var(--muted))] list-disc pl-5">
              {project.highlights.map((h) => (
                <li key={h} className="leading-6">{h}</li>
              ))}
            </ul>
          </div>
        </Reveal>
      ...
      {project.uiImages?.length ? (
        <Reveal>
          <div className="rounded-2xl border border-[rgb(var(--border))] bg-[rgb(var(--bg))] p-5">
            <div className="text-sm font-semibold">UI Screens</div>
            <div className="mt-4 grid sm:grid-cols-2 gap-3">
              {project.uiImages.map((src) => (
                <a
                  key={src}
                  href={src}
                  target="_blank"
                  rel="noreferrer"
                  className="block overflow-hidden rounded-2xl border border-[rgb(var(--border))] bg-[rgb(var(--card))]"
                >
                  <img
                    src={src}
                    alt=""
      ...
      {project.structureImages?.length ? (
        <Reveal>
          <div className="rounded-2xl border border-[rgb(var(--border))] bg-[rgb(var(--bg))] p-5">
            <div className="text-sm font-semibold">Structure / Folder</div>
            <div className="mt-4 grid sm:grid-cols-2 gap-3">
              {project.structureImages.map((src) => (
                <a
                  key={src}
                  href={src}
                  target="_blank"
      ...
      <Reveal>
        <div className="flex flex-wrap gap-2">
          <button
            onClick={() => nav(-1)}
            className="px-4 py-2 rounded-xl border border-[rgb(var(--border))] hover:bg-[rgb(var(--card))] transition text-sm font-semibold"
          >
            Back
          </button>
...
//   demoUrl?: string;
//   repoUrl?: string;
//   images: string[]; // from old uiImages only (links or local)
...
//     liveDemo: "https://github.com/iszzy0wijesinghe/Finance-Tracker",
...
//     problem: "Education Purpose developed android app",
//     description:
...
//     githubRepo:
//       "https://www.figma.com/design/fT7dR8tg45WkxBcu6LH35q/Untitled?node-id=0-1&t=1raTAJFyHGQ3B9AT-1",
//     liveDemo:
//       "https://www.figma.com/proto/fT7dR8tg45WkxBcu6LH35q/Untitled?node-id=0-1&t=1raTAJFyHGQ3B9AT-1",
...
//     githubRepo: "https://github.com/iszzy0wijesinghe/RetailManagementSystem",
//     liveDemo: "",
//     techStack: [
//       "React",
...
//       "MS SQL Server",
//     ],
//     problem: "Educational Project — built for learning purposes only (not production-ready).",
//     description:
//       "A simplified Retail / POS system consisting of a .NET 8 Web API backend and a React + Redux Toolkit + RTK Query frontend. This project demonstrates how to structure a full-stack retail application covering authentication, products & inventory, discounts & coupons, orders & POS, customers, and auditing.",
//     highlights: [
...
//     ],
//     uiImages: [
//       "https://res.cloudinary.com/dfejydorr/image/upload/v1768800298/2_lmahqu.png",
//       "https://res.cloudinary.com/dfejydorr/image/upload/v1768800309/11_uc4a7a.png",
//       "https://res.cloudinary.com/dfejydorr/image/upload/v1768800301/3_u8do5q.png",
//       "https://res.cloudinary.com/dfejydorr/image/upload/v1768800304/4_uhj9i4.png",
//       "https://res.cloudinary.com/dfejydorr/image/upload/v1768800305/5_g5emrt.png",
//       "https://res.cloudinary.com/dfejydorr/image/upload/v1768800305/6_mgmvvl.png",
//       "https://res.cloudinary.com/dfejydorr/image/upload/v1768800336/7_zzj8x9.png",
//       "https://res.cloudinary.com/dfejydorr/image/upload/v1768800321/8_pzpium.png",
//       "https://res.cloudinary.com/dfejydorr/image/upload/v1768800316/9_dkvhc1.png",
//       "https://res.cloudinary.com/dfejydorr/image/upload/v1768800311/10_jugrjr.png",
//       "https://res.cloudinary.com/dfejydorr/image/upload/v1768800311/13_aqdhku.png",
//       "https://res.cloudinary.com/dfejydorr/image/upload/v1768800307/12_zg3mgg.png",
//       "https://res.cloudinary.com/dfejydorr/image/upload/v1768800298/Capture_x8og52.png",
//     ],
//     structureImages: [
//       "https://res.cloudinary.com/dfejydorr/image/upload/v1768800304/16_npndlq.png",
//       "https://res.cloudinary.com/dfejydorr/image/upload/v1768800301/15_exyof8.png",
//       "https://res.cloudinary.com/dfejydorr/image/upload/v1768800309/14_czvam8.png",
//     ],
//   },
// };

// /* ---------------------------------------------
//    Derived data (cards/projects page/home featured)
// ---------------------------------------------- */

// // choose featured projects for Home section
// export const featuredProjectIds = [7, 2, 1];
...
// // ✅ Standard projects list (cards) derived only from projectDetailsById
// export const projects: Project[] = Object.entries(projectDetailsById)
...
//       tech: p.techStack,
//       demoUrl: cleanUrl(p.liveDemo),
//       repoUrl: cleanUrl(p.githubRepo),
//       images: (p.uiImages ?? []).slice(0, 2),
//       featured: featuredProjectIds.includes(numId),
//     };
//   });
...
//   if (/^\d+$/.test(q)) {
//     const hit = projects.find((x) => x.slug === q);
//     return hit ? [hit] : [];
//   }

//   return projects.filter((p) => {
//     const details = projectDetailsById[Number(p.slug)];
